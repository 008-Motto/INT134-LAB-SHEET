...
afternoon.** It starts at its own step 1 and assumes the machine you are leaving with: you unpack
the noticeboard application, already on your VM, serve **your own** site instead of whatever your
machine is serving now, put your student number in it, and find out what a file server does when
you ask it to store something.
